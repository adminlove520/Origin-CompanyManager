...
$(document).ready(function(){
	 ...
	 var password = "${admin.manager_pass}";
		if($("#paramsManager\\.manager_pass").val()=='' || $("#manager_rpass").val()==''|| $("#manager_pass1").val()==''){
			alert('新旧密码和确认密码不能为空');
			return;
		}
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
          ...
          <td>
            <input type="password" id="manager_pass1" name="manager_pass1" />
          </td>
        ...
        <tr>
          ...
          <td>
            <input type="password" id="paramsManager.manager_pass" name="paramsManager.manager_pass"  />
          </td>
          <td align="right" style="padding-right:5px"></td>
          <td>
